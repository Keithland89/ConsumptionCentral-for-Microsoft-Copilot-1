let
    ...
    Roster = Table.Buffer(Table.TransformColumns(
    ...
    Resolved = Table.ExpandTableColumn(Linked, "roster", {"userPrincipalName"}, {"ResolvedKey"}),
    ...
    VivaSource = Inline,
    EntraSource = try VivaOrgFromPeople otherwise null,
